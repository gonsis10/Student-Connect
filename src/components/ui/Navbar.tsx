					...
					{user ? (
						<>
							<div className="flex items-center gap-3">
								...
								<button onClick={handleLogout} className="text-sm text-gray-900 hover:text-gray-800">
									Logout
								</button>
							</div>
						</>
					) : (
						<button onClick={loginWithGoogle} className="text-sm text-gray-900 hover:text-gray-800">
							Sign in
						</button>
					)}
				</div>
